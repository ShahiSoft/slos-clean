	...
	return array(
		...
		'settings' => array(
			'banner_settings' => array(
				...
				'required'   => true,
				'fields'     => array(
					'enabled', 'position', 'theme', 'show_logo', 'logo_url',
					'headline', 'message', 'accept_label', 'reject_label',
					'settings_label', 'show_reject_button', 'show_settings_button',
					'show_descriptions', 'category_descriptions',
