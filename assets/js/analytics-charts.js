...
(function ($) {
	...
	const ShahiAnalyticsCharts = {
		...
		init() {
			console.log(
				'ShahiLegalFlowSuite Analytics: Initializing charts...'
			);
		...
		if (typeof Chart === 'undefined') {
			...
			console.log(
				'ShahiLegalFlowSuite Analytics: Charts initialized successfully'
			);
		},
