...
(function($) {
    ...
    function bindExportForm() {
        $('#slos-export-form').on('submit', function(e) {
            e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success && response.url) {
                    showStatus('#slos-export-status', 'success', 
                    ...
                    showStatus('#slos-export-status', 'error', 
            ...
            success: function(response) {
                if (response.success && response.profile) {
                    ...
                    copyToClipboard(json).then(function() {
                        ...
                        showJSONModal(json);
                        showStatus('#slos-export-status', 'info', 
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success && response.diff) {
                    ...
                    showStatus('#slos-import-status', 'error', 
    ...
    function importConfig() {
        ...
        setButtonLoading($btn, true);
        showStatus('#slos-import-status', 'info', 
    ...
    function bindExportActions() {
        // Download export
        $(document).on('click', '.slos-download-export', function() {
        ...
        // Import from export
        $(document).on('click', '.slos-import-export', function() {
            const filename = $(this).data('filename');
        ...
        // Compare export
        $(document).on('click', '.slos-compare-export', function() {
            const filename = $(this).data('filename');
        ...
        // Delete export
        $(document).on('click', '.slos-delete-export', function() {
            const filename = $(this).data('filename');
    ...
    function showJSONModal(json) {
        const $modal = $('<div class="slos-json-modal"><div class="slos-modal-content">' +
        ...
        $modal.find('.slos-close-modal, .slos-json-modal').on('click', function(e) {
            if (e.target === this) {
