...
(function (blocks, element, blockEditor, components, i18n) {
	...
	const { PanelBody, SelectControl, TextControl, TextareaControl } =
		components;
	const { __ } = i18n;
	 ...
	 */
	registerBlockType('slos/embed-placeholder', {
		title: __('SLOS Embed Placeholder', 'shahi-legalflowsuite'),
		description: __(
			'Insert a consent-blocked embed that requires user permission.',
