jQuery(document).ready(function ($) {
	...
	$('.slos-aw-btn').on('click', function (e) {
		...
		switch (action) {
			...
			case 'reading-guide':
				...
				if ($body.hasClass('slos-aw-reading-guide-active')) {
					if ($('#slos-aw-reading-guide').length === 0) {
						$body.append(
							'<div id="slos-aw-reading-guide" class="slos-aw-reading-guide"></div>'
						);
						$(document).on('mousemove', function (e) {
							$('#slos-aw-reading-guide').css(
								'top',
								e.clientY + 'px'
							);
						});
			...
			case 'align-left':
				$body
					.removeClass('slos-aw-align-center slos-aw-align-right')
					.toggleClass('slos-aw-align-left');
				$btn.toggleClass('is-active');
				$(
					'[data-action="align-center"], [data-action="align-right"]'
				).removeClass('is-active');
				break;

			case 'align-center':
				$body
					.removeClass('slos-aw-align-left slos-aw-align-right')
					.toggleClass('slos-aw-align-center');
				$btn.toggleClass('is-active');
				$(
					'[data-action="align-left"], [data-action="align-right"]'
				).removeClass('is-active');
				break;

			case 'align-right':
				$body
					.removeClass('slos-aw-align-left slos-aw-align-center')
					.toggleClass('slos-aw-align-right');
				$btn.toggleClass('is-active');
				$(
					'[data-action="align-left"], [data-action="align-center"]'
				).removeClass('is-active');
				break;
			...
			case 'grayscale':
				...
				if ($body.hasClass('slos-aw-grayscale')) {
					$body.removeClass(
						'slos-aw-high-contrast slos-aw-negative-contrast slos-aw-monochrome slos-aw-low-saturation'
					);
					$(
						'[data-action="high-contrast"], [data-action="negative-contrast"], [data-action="monochrome"], [data-action="low-saturation"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'monochrome':
				...
				if ($body.hasClass('slos-aw-monochrome')) {
					$body.removeClass(
						'slos-aw-grayscale slos-aw-high-contrast slos-aw-negative-contrast slos-aw-low-saturation'
					);
					$(
						'[data-action="grayscale"], [data-action="high-contrast"], [data-action="negative-contrast"], [data-action="low-saturation"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'low-saturation':
				...
				if ($body.hasClass('slos-aw-low-saturation')) {
					$body.removeClass(
						'slos-aw-grayscale slos-aw-high-contrast slos-aw-negative-contrast slos-aw-monochrome slos-aw-dark-mode slos-aw-blue-light slos-aw-protanopia slos-aw-deuteranopia slos-aw-tritanopia'
					);
					$(
						'[data-action="grayscale"], [data-action="high-contrast"], [data-action="negative-contrast"], [data-action="monochrome"], [data-action="dark-mode"], [data-action="blue-light-filter"], [data-action="protanopia"], [data-action="deuteranopia"], [data-action="tritanopia"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'dark-mode':
				...
				if ($body.hasClass('slos-aw-dark-mode')) {
					$body.removeClass(
						'slos-aw-grayscale slos-aw-high-contrast slos-aw-negative-contrast slos-aw-monochrome slos-aw-low-saturation slos-aw-light-background'
					);
					$(
						'[data-action="grayscale"], [data-action="high-contrast"], [data-action="negative-contrast"], [data-action="monochrome"], [data-action="low-saturation"], [data-action="light-background"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'protanopia':
				...
				$(
					'[data-action="deuteranopia"], [data-action="tritanopia"]'
				).removeClass('is-active');
				break;
			...
			case 'deuteranopia':
				...
				$(
					'[data-action="protanopia"], [data-action="tritanopia"]'
				).removeClass('is-active');
				break;
			...
			case 'tritanopia':
				...
				$(
					'[data-action="protanopia"], [data-action="deuteranopia"]'
				).removeClass('is-active');
				break;
			...
			case 'reading-mask':
				...
				if ($body.hasClass('slos-aw-reading-mask-active')) {
					if ($('#slos-aw-reading-mask-top').length === 0) {
						$body.append(
							'<div id="slos-aw-reading-mask-top" class="slos-aw-reading-mask"></div><div id="slos-aw-reading-mask-bottom" class="slos-aw-reading-mask"></div>'
						);
						$(document).on('mousemove', function (e) {
							const y = e.clientY;
							const height = 100; // Mask opening height
							$('#slos-aw-reading-mask-top').css(
								'height',
								y - height / 2 + 'px'
							);
							$('#slos-aw-reading-mask-bottom').css(
								'top',
								y + height / 2 + 'px'
							);
						});
			...
			case 'page-structure':
				...
				if ($('#slos-aw-structure-modal').length === 0) {
					let structure =
						'<div id="slos-aw-structure-modal" class="slos-aw-modal"><div class="slos-aw-modal-content"><h3>Page Structure</h3><button class="slos-aw-modal-close">×</button><ul>';
					$(
			...
			case 'high-contrast':
				...
				if ($body.hasClass('slos-aw-high-contrast')) {
					$body.removeClass(
						'slos-aw-grayscale slos-aw-negative-contrast'
					);
					$(
						'[data-action="grayscale"], [data-action="negative-contrast"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'negative-contrast':
				...
				if ($body.hasClass('slos-aw-negative-contrast')) {
					$body.removeClass(
						'slos-aw-grayscale slos-aw-high-contrast'
					);
					$(
						'[data-action="grayscale"], [data-action="high-contrast"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'smart-contrast':
				...
				if ($body.hasClass('slos-aw-smart-contrast')) {
					$body.removeClass(
						'slos-aw-grayscale slos-aw-high-contrast slos-aw-negative-contrast slos-aw-monochrome slos-aw-low-saturation slos-aw-dark-mode slos-aw-light-background'
					);
					$(
						'[data-action="grayscale"], [data-action="high-contrast"], [data-action="negative-contrast"], [data-action="monochrome"], [data-action="low-saturation"], [data-action="dark-mode"], [data-action="light-background"]'
					).removeClass('is-active');
				}
				break;
			...
			case 'virtual-keyboard':
				...
				if ($body.hasClass('slos-aw-virtual-keyboard-active')) {
					if ($('#slos-aw-virtual-keyboard').length === 0) {
						...
						let keyboardHtml =
							'<div id="slos-aw-virtual-keyboard" class="slos-aw-virtual-keyboard"><div class="slos-aw-vk-header">Virtual Keyboard <span class="slos-aw-vk-close">×</span></div><div class="slos-aw-vk-keys">';
						keys.forEach((key) => {
							keyboardHtml += `<button class="slos-aw-vk-key" data-key="${key}">${
								key === 'Space' ? ' ' : key
							}</button>`;
						});
						...
						$('.slos-aw-vk-close').on('click', function () {
							$body.removeClass(
								'slos-aw-virtual-keyboard-active'
							);
							$('[data-action="virtual-keyboard"]').removeClass(
								'is-active'
							);
							$vk.hide();
						});
							...
							fetch(
								...
								.then((data) => {
									if (
										...
										if (
											$('#slos-aw-dictionary-modal')
												.length === 0
										) {
											$body.append(
												'<div id="slos-aw-dictionary-modal" class="slos-aw-modal"><div class="slos-aw-modal-content"><h3>Dictionary</h3><button class="slos-aw-modal-close-dict">×</button><div id="slos-aw-dict-content"></div></div></div>'
											);
											$('.slos-aw-modal-close-dict').on(
												'click',
												function () {
													$(
														'#slos-aw-dictionary-modal'
										...
										$('#slos-aw-dict-content').html(
											`<strong>${word}</strong> ${phonetic}<br><br>${meaning}`
										);
			...
			case 'translate':
				window.open(
					`https://translate.google.com/translate?sl=auto&tl=en&u=${encodeURIComponent(
