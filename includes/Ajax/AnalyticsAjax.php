...
class AnalyticsAjax {
	...
	public function get_analytics() {
		...
		// Get parameters..
		$period = isset( $_POST['period'] ) ? sanitize_text_field( wp_unslash( <?php
/**
 * Analytics AJAX Handler
 *
 * Handles AJAX requests for analytics data.
...
POST['period'] ) ) : '30days';
	...
	public function export_analytics() {
		...
		// Get date range..
		$start_date = isset( $_POST['start_date'] ) ? sanitize_text_field( wp_unslash( <?php
/**
 * Analytics AJAX Handler
 *
 * Handles AJAX requests for analytics data.
...
POST['start_date'] ) ) : '';
		$end_date   = isset( $_POST['end_date'] ) ? sanitize_text_field( wp_unslash( <?php
/**
 * Analytics AJAX Handler
 *
 * Handles AJAX requests for analytics data.
