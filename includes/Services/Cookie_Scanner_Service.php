...
class Cookie_Scanner_Service extends Base_Service {
    ...
    public function get_categories(): array {
        return array(
            array('id' => 'necessary', 'label' => __( 'Necessary', 'shahi-legalflowsuite' ), 'required' => true),
            array('id' => 'functional', 'label' => __( 'Functional', 'shahi-legalflowsuite' ), 'required' => false),
            array('id' => 'analytics', 'label' => __( 'Analytics', 'shahi-legalflowsuite' ), 'required' => false),
            array('id' => 'marketing', 'label' => __( 'Marketing', 'shahi-legalflowsuite' ), 'required' => false),
            array('id' => 'preferences', 'label' => __( 'Preferences', 'shahi-legalflowsuite' ), 'required' => false),
            array('id' => 'personalization', 'label' => __( 'Personalization', 'shahi-legalflowsuite' ), 'required' => false),
        );
    }
