...
<div class="slos-audit-container">
	...
	<div class="slos-audit-filters">
		<div class="slos-date-range">
			<input type="date" id="log-date-from" value="<?php echo esc_attr( gmdate( 'Y-m-d', strtotime( '-30 days' ) ) ); ?>">
			<span><?php esc_html_e( 'to', 'shahi-legalflowsuite' ); ?></span>
			<input type="date" id="log-date-to" value="<?php echo esc_attr( gmdate( 'Y-m-d' ) ); ?>">
		</div>
	...
	<div class="slos-log-card">
		...
		<div class="slos-pagination">
			...
			<button class="slos-page-btn"><?php echo esc_html( (int) ceil( $total_logs / 25 ) ); ?></button>
				<?php endif; ?>
