	...
	<div class="shahi-modules-container">
		<div class="shahi-modules-grid shahi-modules-grid-premium" data-view="grid">
			<?php foreach ( $modules as $module ) : ?>
					<div class="shahi-module-card shahi-module-card-premium <?php echo esc_attr( $module['enabled'] ? 'active' : 'inactive' ); ?>" 
						data-module="<?php echo esc_attr( $module['slug'] ); ?>"
						data-status="<?php echo esc_attr( $module['enabled'] ? 'active' : 'inactive' ); ?>"
