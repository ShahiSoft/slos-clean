...
namespace ShahiLegalFlowSuite\Modules\LegalDocs;

use ShahiLegalFlowSuite\Modules\Module;
use ShahiLegalFlowSuite\Admin\Document_Hub_Controller;
use ShahiLegalFlowSuite\Admin\Profile_Wizard;
...
class LegalDocuments extends Module
{
    ...
    {
        return __('Legal Documents', 'shahi-legalflowsuite');
    }
    ...
    {
        return __('Generate and manage legal documents for your website.', 'shahi-legalflowsuite');
    }
    ...
    public function register_admin_menu()
    {
        add_submenu_page(
            ...
            __('Legal Documents', 'shahi-legalflowsuite'),
            '📄 ' . __('Documents', 'shahi-legalflowsuite'),
        ...
        add_submenu_page(
            ...
            'manage_shahi_modules',
            'slos-edit-document',
            array(new \ShahiLegalFlowSuite\Admin\Document_Editor_Controller(), 'render')
        );
    }
