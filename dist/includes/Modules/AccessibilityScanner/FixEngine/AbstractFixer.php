...
abstract class AbstractFixer implements FixerInterface {
	...
	public function __construct() {
		...
		if ( empty( $this->canonical_id ) ) {
			Logger::error(
				'Fixer ID not in canonical registry',
				array(
					'fixer_id'    => $id,
	 ...
	 * @return FixResult
	 */
	public function fix( string $content, array $options = array() ): FixResult {
		try {
	 ...
	 * @return FixResult
	 */
	abstract protected function apply_fix( string $content, array $options = array() ): FixResult;
	 ...
	 * @return \DOMElement
	 */
	protected function create_element( string $tag, array $attributes = array(), string $text = '' ): \DOMElement {
