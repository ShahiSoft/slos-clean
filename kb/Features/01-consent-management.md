...
2. Choose banner template
3. Customize text and colors
4. Enable cookie scanner
5. Save settings

### Advanced Setup
1. Configure geo-targeting rules
...
- ✓ No external API calls (geo detection via option)
- ✓ All data stored locally in database
- ✓ No tracking or analytics from Shahi
