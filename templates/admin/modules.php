...
<div class="wrap shahi-legalflowsuite-admin shahi-modules-page">
	...
	<div class="shahi-modules-stats">
		<div class="shahi-stat-card">
			<div class="shahi-stat-value"><?php echo esc_html( count( (array) $modules ) ); ?></div>
		...
		<div class="shahi-stat-card shahi-stat-success">
			<div class="shahi-stat-value"><?php echo esc_html( (int) $active_count ); ?></div>
		...
		<div class="shahi-stat-card shahi-stat-secondary">
			<div class="shahi-stat-value"><?php echo esc_html( max( 0, count( (array) $modules ) - (int) $active_count ) ); ?></div>
