...
jQuery(document).ready(function($) {
    ...
    $('#save-banner').on('click', function() {
        ...
        $btn.prop('disabled', true).html('<span class="dashicons dashicons-update" style="animation: spin 1s linear infinite; margin-right: 6px;"></span> <?php echo esc_js( __( 'Saving...', 'shahi-legalflowsuite' ) ); ?>');
        ...
        $.ajax({
            ...
            success: function(response) {
                $btn.prop('disabled', false).removeClass('has-changes').html('<span class="dashicons dashicons-yes" style="margin-right: 6px;"></span> <?php echo esc_js( __( 'Saved!', 'shahi-legalflowsuite' ) ); ?>');
            ...
            error: function(xhr) {
                ...
                const errMsg = xhr.responseJSON?.message || '<?php echo esc_js( __( 'Failed to save settings. Please try again.', 'shahi-legalflowsuite' ) ); ?>';
                alert(errMsg);
            }
        });
    });
