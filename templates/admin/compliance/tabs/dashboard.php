...
<div class="slos-two-col-grid">
	...
	<div class="slos-main-column">
		...
		<div class="slos-card">
			...
			<p class="slos-widget-description">
				<?php esc_html_e( 'Multi-dimensional compliance configuration assessment. This score reflects how well your site is configured for privacy compliance across key dimensions: cookies, legal docs, consent data, scan freshness, and banner configuration.', 'shahi-legalflowsuite' ); ?>
			</p>
			<div class="slos-card-body">
				...
				<div class="slos-dimensions-grid" style="margin-top: 24px; display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 12px;">
					<?php if ( ! empty( $stats['dimensions'] ) ) : ?>
						<?php
						foreach ( $stats['dimensions'] as $dimension_key => $dimension_data ) :
		...
		<div class="slos-card" style="margin-top: 24px;">
			...
			<p class="slos-widget-description">
				<?php esc_html_e( 'Latest consent interactions from your visitors. Click the view button to see full consent details.', 'shahi-legalflowsuite' ); ?>
			</p>
	...
	<div class="slos-sidebar-column">
		...
		<div class="slos-card" style="margin-top: 24px;">
			...
			<p class="slos-widget-description">
				<?php esc_html_e( 'Region-specific consent rules currently active for showing appropriate consent banners based on visitor location.', 'shahi-legalflowsuite' ); ?>
			</p>
			<div class="slos-card-body">
				...
				<div class="slos-empty-state" style="padding: 20px; text-align: center;">
					...
					<p style="color: var(--slos-text-muted); margin-top: 8px;"><?php esc_html_e( 'No geo rules configured for regional compliance.', 'shahi-legalflowsuite' ); ?></p>
				</div>
				<?php endif; ?>
			</div>
		</div>
			...
			<div class="slos-card-body">
				...
				<div class="slos-document-list">
					<?php if ( ! empty( $legal_docs['docs'] ) ) : ?>
						<?php
						foreach ( $legal_docs['docs'] as $doc_id => $doc ) :
