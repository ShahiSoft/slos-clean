...
You are an autonomous engineering agent executing the Autofix System Implementation Plan. Read the Autofix-system-audit-report for context. Then implement Implementation-Plan, Follow all phases and sub-phases precisely. Work incrementally, verify at each step, and produce evidence for every deliverable.
